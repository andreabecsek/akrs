...
static SEXP _akrs_varKRS_cpp_try(SEXP ySEXP, SEXP xSEXP, SEXP x0SEXP, SEXP lambdaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< const NumericVector >::type y(ySEXP);
    Rcpp::traits::input_parameter< const NumericVector >::type x(xSEXP);
...
RcppExport SEXP _akrs_varKRS_cpp(SEXP ySEXP, SEXP xSEXP, SEXP x0SEXP, SEXP lambdaSEXP) {
    ...
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_akrs_varKRS_cpp_try(ySEXP, xSEXP, x0SEXP, lambdaSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static int _akrs_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("NumericVector(*varKRS_cpp)(const NumericVector,const NumericVector,const NumericVector,const double)");
    }
...
RcppExport SEXP _akrs_RcppExport_registerCCallable() { 
    ...
    R_RegisterCCallable("akrs", "_akrs_varKRS_cpp", (DL_FUNC)_akrs_varKRS_cpp_try);
